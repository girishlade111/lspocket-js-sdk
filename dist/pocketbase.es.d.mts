...
declare abstract class BaseService {
    readonly client: LSPocket;
    constructor(client: LSPocket);
}
...
declare class RecordService<M = RecordModel> extends CrudService<M> {
    ...
    constructor(client: LSPocket, collectionIdOrName: string);
    /**
     * @inheritdoc
     */
     ...
     * @throws {ClientResponseError}
     */
    impersonate(recordId: string, duration: number, options?: CommonOptions): Promise<LSPocket>;
...
export { AsyncAuthStore, BaseAuthStore, BatchService, ClientResponseError, CollectionService, CrudService, HealthService, LocalAuthStore, LogService, RealtimeService, RecordService, SubBatchService, cookieParse, cookieSerialize, LSPocket as default, getTokenPayload, isTokenExpired, normalizeUnknownQueryParams, serializeQueryParams };
export type { AsyncClearFunc, AsyncSaveFunc, AuthAlertConfig, AuthCollectionModel, AuthMethodsList, AuthModel, AuthOptions, AuthProviderInfo, AuthRecord, BaseCollectionModel, BaseModel, BatchRequest, BatchRequestResult, BeforeSendResult, CollectionField, CollectionModel, CommonOptions, ConfigurableOAuth2Provider, EmailTemplate, FileOptions, FullListOptions, HealthCheckResponse, HourlyStats, ListOptions, ListResult, LogModel, LogStatsOptions, MFAConfig, OAuth2AuthConfig, OAuth2Config, OAuth2Provider, OAuth2UrlCallback, OTPConfig, OTPResponse, OnStoreChangeFunc, ParseOptions, PasswordAuthConfig, RecordAuthResponse, RecordFullListOptions, RecordListOptions, RecordModel, RecordOptions, RecordSubscribeOptions, RecordSubscription, SendOptions, SerializeOptions, TokenConfig, UnsubscribeFunc, ViewCollectionModel };
